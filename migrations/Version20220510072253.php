 ...
 */
final class Version20220510072253 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE operations (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, categories_id INT NOT NULL, users_id INT DEFAULT NULL, description LONGTEXT NOT NULL, titre VARCHAR(255) NOT NULL, status TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, finish_at DATETIME DEFAULT NULL, abort TINYINT(1) NOT NULL, aborted_at DATETIME DEFAULT NULL, INDEX IDX_2814534819EB6921 (client_id), INDEX IDX_28145348A21214B7 (categories_id), INDEX IDX_2814534867B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
